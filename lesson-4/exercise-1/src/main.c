...
/* STEP 9.2 - Define the application callback function for reading the state of
 * the button */
static bool app_button_cb(void) { return app_button_state; }

/* STEP 10 - Declare a variable app_callbacks of type my_lbs_cb and initiate its
 * members to the applications call back functions we developed in steps 8.2
 * and 9.2. */
...
int main(void) {
  ...
  /* STEP 11 - Pass your application callback functions stored in app_callbacks
   * to the MY LBS service */
